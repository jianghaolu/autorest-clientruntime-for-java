/*
 * ORIGINAL Copyright (C) 2009 The Guava Authors
 *
 ...
 * the License.
 *
 * MODIFIED Copyright (c) Microsoft Corporation. All rights reserved.
...
public final class UrlEscapers {
    ...
    /**
     * Returns an {@link PercentEscaper} instance that escapes strings so they can be safely included in <a
     ...
     *
     */
    public static PercentEscaper urlFormParameterEscaper() {
        return URL_FORM_PARAMETER_ESCAPER;
    }

    private static final PercentEscaper URL_FORM_PARAMETER_ESCAPER =
    ...
    /**
     * Returns an {@link PercentEscaper} instance that escapes strings so they can be safely included in a <a
     ...
     * href="https://url.spec.whatwg.org/#percent-encode">uppercase</a> hexadecimal sequences.
     */
    public static PercentEscaper urlFragmentEscaper() {
        return URL_FRAGMENT_ESCAPER;
    }

    private static final PercentEscaper URL_FRAGMENT_ESCAPER =
            new PercentEscaper(URL_PATH_OTHER_SAFE_CHARS_LACKING_PLUS + "+/?", false);
}

 ...
 *
 * <p>The two primary implementations of this interface are {@code CharEscaper} and {@link
 ...
 * com.google.common.html.HtmlEscapers} and {@code com.google.common.xml.XmlEscapers}. To create
 * your own escapers, use {@code CharEscaperBuilder}, or extend {@code CharEscaper} or {@code
 * UnicodeEscaper}.
 *
...
public abstract class Escaper {
     ...
     *   <li>{@code CharEscaper} handles Java characters independently and does not verify the input
